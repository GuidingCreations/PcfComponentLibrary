# ShadCN Navigation Menu component for Power Apps (PCF COMPONENT)

## Description
### This is a navigation menu, meant to sit at the top of your application, which will list out the possible screens to navigate to in your application. This includes drop-downs in the nav menu, which allows you to group similar screens together to both save space and provide visual distinction that they belong together.
