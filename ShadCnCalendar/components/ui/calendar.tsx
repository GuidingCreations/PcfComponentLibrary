...
function Calendar({
  ...
  console.log("props dark mode: ", props.darkMode)
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "relative w-full h-full p-0 text-center [&:last-child[data-selected=true]_button]:rounded-r-md group/day aspect-square select-none testprop",
        ...
        range_start: cn(
          "rounded-l-md bg-accent primaryColor",
          defaultClassNames.range_start
        ),
        range_middle: cn("rounded-none", defaultClassNames.range_middle),
        range_end: cn("rounded-r-md bg-accent primaryColor", defaultClassNames.range_end),
        today: cn(
